...
class AddHotelGovernorate extends StatelessWidget {
  const AddHotelGovernorate({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Add Governorate For A Hotel',style: TextStyle(fontWeight: FontWeight.bold),),
